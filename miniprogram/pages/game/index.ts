...
import { Player, GameMode, GameConfig, GameState, GamePhase, GameResult } from '../../core/types';
...
Page({
  data: {
    ...
    prevLastMove: null as any, // 用于检测 AI 落子
  ...
  onLoad(query: Record<string, string>) {
    ...
    const mode = (query.mode as GameMode) || GameMode.PVE;
  ...
  initNewGame(query: Record<string, string>) {
    // 读取游戏设置
    const settings = wx.getStorageSync('gameSettings') || {};
  ...
  isProcessingMoveSync: false as boolean,
